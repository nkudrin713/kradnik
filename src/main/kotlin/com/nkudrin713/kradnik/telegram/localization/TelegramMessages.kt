...
enum class TelegramMessage(val key: String) {
    ...
    STATUS_CANCELLED_BY_USER("status.cancelled-by-user"),
    ACTION_CANCEL("action.cancel"),
    ACTION_BACK_TO_OPTIONS("action.back-to-options"),
    ...
    CHOICE_PLAYLIST_ZIP_ALL("choice.playlist-zip-all"),
    CHOICE_PLAYLIST_ZIP_FIRST("choice.playlist-zip-first"),
    CHOICE_PLAYLIST_ZIP_LAST("choice.playlist-zip-last"),
    CHOICE_PLAYLIST_ALL("choice.playlist-all"),
    CHOICE_PLAYLIST_FIRST("choice.playlist-first"),
    CHOICE_PLAYLIST_LAST("choice.playlist-last"),
    ...
    DOWNLOAD_ALREADY_FINISHED("download.already-finished"),
    PLAYLIST_TRACK_COUNT("playlist.track-count"),
    PLAYLIST_TOTAL_DURATION("playlist.total-duration"),
    PLAYLIST_AUDIO_FORMAT("playlist.audio-format"),
    PLAYLIST_DELIVERY_PARTS("playlist.delivery-parts"),
    PLAYLIST_COMPLETED_WITH_ERRORS("playlist.completed-with-errors"),
    ...
    ERROR_PLAYLIST_DIRECT_CHAT_ONLY("error.playlist-direct-chat-only"),
    ERROR_PLAYLIST_ZIP_TOO_LARGE("error.playlist-zip-too-large"),
    ERROR_PLAYLIST_ITEM_TOO_LARGE("error.playlist-item-too-large"),
}
